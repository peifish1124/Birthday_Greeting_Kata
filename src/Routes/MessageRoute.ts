...
import XmlMessageController from "../Controllers/XmlMessageController.js";
...
router.get("/v0/messages", (req: Request, res: Response) => {
    const messageController = new XmlMessageController(new MockMemberHandler(), new MessageHandlerVersion1());
    messageController.getMessages(req, res);
});

// GET: /api/v1/messages?month=8&day=8
router.get("/v1/messages", (req: Request, res: Response) => {
    const messageController = new XmlMessageController(new MongodbMemberHandler(), new MessageHandlerVersion1());
    messageController.getMessages(req, res);
});

// GET: /api/v2/messages?month=8&day=8
router.get("/v2/messages", (req: Request, res: Response) => {
    const messageController = new XmlMessageController(new MongodbMemberHandler(), new MessageHandlerVersion2());
    messageController.getMessages(req, res);
});

// GET: /api/v3/messages?month=12&day=22
router.get("/v3/messages", (req: Request, res: Response) => {
    const messageController = new XmlMessageController(new MongodbMemberHandler(), new MessageHandlerVersion3());
    messageController.getMessages(req, res);
});

// GET: /api/v4/messages?month=8&day=8
router.get("/v4/messages", (req: Request, res: Response) => {
    const messageController = new XmlMessageController(new MongodbMemberHandler(), new MessageHandlerVersion4());
    messageController.getMessages(req, res);
});
